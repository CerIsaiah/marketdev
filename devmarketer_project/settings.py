...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^#p144u_(ev)@1ni!@#g(f_gaet@vh%fq^wc3h@+@(lq#tzma9')
...
# Ensure marketdev.onrender.com is in ALLOWED_HOSTS
if 'marketdev.onrender.com' not in ALLOWED_HOSTS:
    ALLOWED_HOSTS.append('marketdev.onrender.com')
